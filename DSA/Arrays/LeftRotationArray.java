// Statement: Write a program to rotate the array to the left by k steps.
...
public class LeftRotationArray {
    public static void rotateArray(int[] arr, int n, int k){
        ...
        reverseArray(arr, k, n-1);                      // [3, 2, 1, "7, 6, 5, 4"]
        // this will reverse the complete array.
        reverseArray(arr, 0, n-1);                // [4, 5, 6, 7, 1, 2, 3]
    }
